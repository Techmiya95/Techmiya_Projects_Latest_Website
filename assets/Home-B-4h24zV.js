import{j as e,S as x}from"./index-D3kiUueH.js";import{b as a}from"./vendor-BqpI3quz.js";const g=[{name:"Vajra",review:"I have tried many tools, but this one stands out.",rating:4,image:"/images/user1.webp"},{name:"Hamsa Lekha R",review:"The software provided by Techmiya Solutions has been a game-changer for us.",rating:5,image:"/images/user2.webp"},{name:"Tejaswini",review:"Working with Techmiya Solutions was a breeze!",rating:4.5,image:"/images/user3.webp"},{name:"Varsha HD",review:"Techmiya Solutions revolutionized the way we handle our business processes.",rating:5,image:"/images/user4.webp"},{name:"Trupthi",review:"The customer support from Techmiya Solutions is exceptional.",rating:4,image:"/images/user5.webp"},{name:"Sanjay",review:"We've been using Techmiya Solutions for over a year, and it's been a game-changer.",rating:4,image:"/images/user6.webp"},{name:"Prasad",review:"I was impressed by how quickly Techmiya Solutions understood our business needs and delivered a solution that exceeded our expectations.",rating:4.5,image:"/images/user7.webp"},{name:"Tameem",review:"The ease of use and customization options are fantastic.",rating:5,image:"/images/user8.webp"},{name:"Mohan",review:"Techmiya Solutions' software is exactly what we needed. It's fast, reliable, and incredibly easy to navigate.",rating:4.5,image:"/images/user9.webp"},{name:"Adil",review:"The best decision we made for our business was partnering with Techmiya Solutions.",rating:5,image:"/images/user10.webp"},{name:"Mudashir",review:"The best decision we made for our business was partnering with Techmiya Solutions.",rating:5,image:"/images/user11.webp"}];function f({rating:n}){const d=Math.floor(n),c=n%1!==0,r=5-d-(c?1:0);return e.jsxs(e.Fragment,{children:[[...Array(d)].map((s,l)=>e.jsx("i",{className:"fa fa-star"},`full-${l}`)),c&&e.jsx("i",{className:"fa fa-star-half-o"}),[...Array(r)].map((s,l)=>e.jsx("i",{className:"fa fa-star-o"},`empty-${l}`))]})}function j(){const n=[...g,...g],[d,c]=a.useState(!1),r=a.useRef(null);return a.useEffect(()=>{let s;const l=new IntersectionObserver(t=>{t.forEach(m=>{m.isIntersecting&&!d&&(s=setTimeout(()=>{c(!0)},800))})},{threshold:.1});return r.current&&l.observe(r.current),()=>{r.current&&l.unobserve(r.current),s&&clearTimeout(s)}},[d]),e.jsx("section",{className:"testimonials",ref:r,children:e.jsxs("div",{className:"testimonial-container",children:[e.jsx("h2",{children:"Hear From Our Customers"}),e.jsx("div",{className:`testimonial-slider ${d?"animate":""}`,children:n.map((s,l)=>e.jsxs("div",{className:"testimonial-col",children:[e.jsx("img",{loading:"lazy",src:s.image,alt:"Techmiya review"}),e.jsxs("div",{children:[e.jsx("p",{children:s.review}),e.jsx("h3",{children:s.name}),e.jsx(f,{rating:s.rating})]})]},l))})]})})}const b=[{id:"1",videoId:"0Fe2Lpk91R0"},{id:"2",videoId:"UgF29StIDt4"},{id:"3",videoId:"0Fe2Lpk91R0"},{id:"4",videoId:"UgF29StIDt4"},{id:"5",videoId:"0Fe2Lpk91R0"},{id:"6",videoId:"UgF29StIDt4"}];function w(){const[n,d]=a.useState(b),[c,r]=a.useState(!1),[s,l]=a.useState(null),t=a.useRef(null);a.useEffect(()=>{},[void 0,"UC_x5XG1OV2P6uYZ5ujfWXBw"]);const h=[...n,...n];return a.useEffect(()=>{let i;const o=new IntersectionObserver(p=>{p.forEach(u=>{u.isIntersecting&&!c&&(i=setTimeout(()=>{r(!0)},800))})},{threshold:.1});return t.current&&o.observe(t.current),()=>{t.current&&o.unobserve(t.current),i&&clearTimeout(i)}},[c,n]),e.jsxs("section",{className:"shorts",ref:t,children:[e.jsxs("div",{className:"shorts-container",children:[e.jsx("h2",{children:"Our Projects"}),e.jsx("div",{className:`shorts-slider ${c&&!s?"animate":""}`,children:h.map((i,o)=>e.jsx("div",{className:"shorts-col",children:s===o?e.jsx("iframe",{width:"100%",height:"100%",src:`https://www.youtube.com/embed/${i.videoId}?autoplay=1&mute=0`,title:"YouTube Video",frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullScreen:!0}):e.jsxs("div",{className:"video-placeholder",onClick:()=>{l(o),r(!1)},children:[e.jsx("img",{src:`https://img.youtube.com/vi/${i.videoId}/hqdefault.jpg`,alt:"Video Thumbnail",loading:"lazy"}),e.jsx("div",{className:"play-overlay",children:e.jsx("i",{className:"fa fa-play-circle"})})]})},o))})]}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
                .video-placeholder {
                    position: relative;
                    width: 100%;
                    height: 100%;
