import{j as e,S as v}from"./index-CZoa-yO9.js";import{b as i}from"./vendor-BqpI3quz.js";const g=[{name:"Vajra",review:"I have tried many tools, but this one stands out.",rating:4,image:"/images/user1.webp"},{name:"Hamsa Lekha R",review:"The software provided by Techmiya Solutions has been a game-changer for us.",rating:5,image:"/images/user2.webp"},{name:"Tejaswini",review:"Working with Techmiya Solutions was a breeze!",rating:4.5,image:"/images/user3.webp"},{name:"Varsha HD",review:"Techmiya Solutions revolutionized the way we handle our business processes.",rating:5,image:"/images/user4.webp"},{name:"Trupthi",review:"The customer support from Techmiya Solutions is exceptional.",rating:4,image:"/images/user5.webp"},{name:"Sanjay",review:"We've been using Techmiya Solutions for over a year, and it's been a game-changer.",rating:4,image:"/images/user6.webp"},{name:"Prasad",review:"I was impressed by how quickly Techmiya Solutions understood our business needs and delivered a solution that exceeded our expectations.",rating:4.5,image:"/images/user7.webp"},{name:"Tameem",review:"The ease of use and customization options are fantastic.",rating:5,image:"/images/user8.webp"},{name:"Mohan",review:"Techmiya Solutions' software is exactly what we needed. It's fast, reliable, and incredibly easy to navigate.",rating:4.5,image:"/images/user9.webp"},{name:"Adil",review:"The best decision we made for our business was partnering with Techmiya Solutions.",rating:5,image:"/images/user10.webp"},{name:"Mudashir",review:"The best decision we made for our business was partnering with Techmiya Solutions.",rating:5,image:"/images/user11.webp"}];function f({rating:l}){const d=Math.floor(l),c=l%1!==0,a=5-d-(c?1:0);return e.jsxs(e.Fragment,{children:[[...Array(d)].map((s,o)=>e.jsx("i",{className:"fa fa-star"},`full-${o}`)),c&&e.jsx("i",{className:"fa fa-star-half-o"}),[...Array(a)].map((s,o)=>e.jsx("i",{className:"fa fa-star-o"},`empty-${o}`))]})}function j(){const l=[...g,...g],[d,c]=i.useState(!1),a=i.useRef(null);return i.useEffect(()=>{let s;const o=new IntersectionObserver(r=>{r.forEach(h=>{h.isIntersecting&&!d&&(s=setTimeout(()=>{c(!0)},800))})},{threshold:.1});return a.current&&o.observe(a.current),()=>{a.current&&o.unobserve(a.current),s&&clearTimeout(s)}},[d]),e.jsx("section",{className:"testimonials",ref:a,children:e.jsxs("div",{className:"testimonial-container",children:[e.jsx("h2",{children:"Hear From Our Customers"}),e.jsx("div",{className:`testimonial-slider ${d?"animate":""}`,children:l.map((s,o)=>e.jsxs("div",{className:"testimonial-col",children:[e.jsx("img",{loading:"lazy",src:s.image,alt:"Techmiya review"}),e.jsxs("div",{children:[e.jsx("p",{children:s.review}),e.jsx("h3",{children:s.name}),e.jsx(f,{rating:s.rating})]})]},o))})]})})}const b=[{id:"1",videoId:"0Fe2Lpk91R0"},{id:"2",videoId:"UgF29StIDt4"},{id:"3",videoId:"0Fe2Lpk91R0"},{id:"4",videoId:"UgF29StIDt4"},{id:"5",videoId:"0Fe2Lpk91R0"},{id:"6",videoId:"UgF29StIDt4"}];function w(){const[l,d]=i.useState(b),[c,a]=i.useState(!1),[s,o]=i.useState(null),r=i.useRef(null);i.useEffect(()=>{},[void 0,"UC_x5XG1OV2P6uYZ5ujfWXBw"]);const u=[...l,...l];return i.useEffect(()=>{let t;const n=new IntersectionObserver(p=>{p.forEach(x=>{x.isIntersecting&&!c&&(t=setTimeout(()=>{a(!0)},800))})},{threshold:.1});return r.current&&n.observe(r.current),()=>{r.current&&n.unobserve(r.current),t&&clearTimeout(t)}},[c,l]),e.jsxs("section",{className:"shorts",ref:r,children:[e.jsxs("div",{className:"shorts-container",children:[e.jsx("h2",{children:"Our Projects"}),e.jsx("div",{className:`shorts-slider ${c&&!s?"animate":""}`,children:u.map((t,n)=>e.jsx("div",{className:"shorts-col",children:s===n?e.jsx("iframe",{width:"100%",height:"100%",src:`https://www.youtube.com/embed/${t.videoId}?autoplay=1&mute=0`,title:"YouTube Video",frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullScreen:!0}):e.jsxs("div",{className:"video-placeholder",onClick:()=>{o(n),a(!1)},children:[e.jsx("img",{src:`https://img.youtube.com/vi/${t.videoId}/hqdefault.jpg`,alt:"Video Thumbnail",loading:"lazy"}),e.jsx("div",{className:"play-overlay",children:e.jsx("i",{className:"fa fa-play-circle"})})]})},n))})]}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
                .video-placeholder {
                    position: relative;
                    width: 100%;
                    height: 100%;
            ...
            `}})]})}const y=[{id:"v1",videoId:"ttej9TVU9WM"},{id:"v2",videoId:"13GYx-siWeY"},{id:"v3",videoId:"S7cmcCuEH5w"}];function N(){const[l,d]=i.useState(y),[c,a]=i.useState(!1),[s,o]=i.useState(null),r=i.useRef(null);i.useEffect(()=>{},[void 0,"UC_x5XG1OV2P6uYZ5ujfWXBw"]);const u=[...l,...l];return i.useEffect(()=>{let t;const n=new IntersectionObserver(p=>{p.forEach(x=>{x.isIntersecting&&!c&&(t=setTimeout(()=>{a(!0)},800))})},{threshold:.1});return r.current&&n.observe(r.current),()=>{r.current&&n.unobserve(r.current),t&&clearTimeout(t)}},[c,l]),e.jsxs("section",{className:"video-testimonials",ref:r,children:[e.jsxs("div",{className:"video-testimonials-container",children:[e.jsx("h2",{children:"Video Reviews from Our Students"}),e.jsx("div",{className:`video-testimonials-slider ${c&&!s?"animate":""}`,children:u.map((t,n)=>e.jsx("div",{className:"video-review-col",children:s===n?e.jsx("iframe",{width:"100%",height:"100%",src:`https://www.youtube.com/embed/${t.videoId}?autoplay=1&mute=0`,title:"YouTube Review Video",frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullScreen:!0}):e.jsxs("div",{className:"video-placeholder",onClick:()=>{o(n),a(!1)},children:[e.jsx("img",{src:`https://img.youtube.com/vi/${t.videoId}/hqdefault.jpg`,alt:"Video Review Thumbnail",loading:"lazy"}),e.jsx("div",{className:"play-overlay",children:e.jsx("i",{className:"fa fa-play-circle"})}),e.jsx("div",{className:"review-label",children:"Student Review"})]})},n))})]}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
                .video-testimonials {
                    width: 100%;
                    margin: auto;
                    padding: 80px 0;
