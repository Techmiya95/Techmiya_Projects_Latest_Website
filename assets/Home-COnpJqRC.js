import{j as e,S as u}from"./index-B0pwuZId.js";import{b as r}from"./vendor-3PyanEma.js";const h=[{name:"Vajra",review:"I have tried many tools, but this one stands out.",rating:4,image:"/images/user1.jpeg"},{name:"Hamsa Lekha R",review:"The software provided by Techmiya Solutions has been a game-changer for us.",rating:5,image:"/images/user2.jpeg"},{name:"Tejaswini",review:"Working with Techmiya Solutions was a breeze!",rating:4.5,image:"/images/user3.jpeg"},{name:"Varsha HD",review:"Techmiya Solutions revolutionized the way we handle our business processes.",rating:5,image:"/images/user4.jpeg"},{name:"Trupthi",review:"The customer support from Techmiya Solutions is exceptional.",rating:4,image:"/images/user5.jpeg"},{name:"Sanjay",review:"We've been using Techmiya Solutions for over a year, and it's been a game-changer.",rating:4,image:"/images/user6.jpeg"},{name:"Prasad",review:"I was impressed by how quickly Techmiya Solutions understood our business needs and delivered a solution that exceeded our expectations.",rating:4.5,image:"/images/user7.jpeg"},{name:"Tameem",review:"The ease of use and customization options are fantastic.",rating:5,image:"/images/user8.jpeg"},{name:"Mohan",review:"Techmiya Solutions' software is exactly what we needed. It's fast, reliable, and incredibly easy to navigate.",rating:4.5,image:"/images/user9.jpeg"},{name:"Adil",review:"The best decision we made for our business was partnering with Techmiya Solutions.",rating:5,image:"/images/user10.jpeg"},{name:"Mudashir",review:"The best decision we made for our business was partnering with Techmiya Solutions.",rating:5,image:"/images/user11.jpeg"}];function x({rating:t}){const o=Math.floor(t),n=t%1!==0,a=5-o-(n?1:0);return e.jsxs(e.Fragment,{children:[[...Array(o)].map((s,i)=>e.jsx("i",{className:"fa fa-star"},`full-${i}`)),n&&e.jsx("i",{className:"fa fa-star-half-o"}),[...Array(a)].map((s,i)=>e.jsx("i",{className:"fa fa-star-o"},`empty-${i}`))]})}function v(){const t=[...h,...h],[o,n]=r.useState(!1),a=r.useRef(null);return r.useEffect(()=>{let s;const i=new IntersectionObserver(c=>{c.forEach(m=>{m.isIntersecting&&!o&&(s=setTimeout(()=>{n(!0)},800))})},{threshold:.1});return a.current&&i.observe(a.current),()=>{a.current&&i.unobserve(a.current),s&&clearTimeout(s)}},[o]),e.jsx("section",{className:"testimonials",ref:a,children:e.jsxs("div",{className:"testimonial-container",children:[e.jsx("h2",{children:"Hear From Our Customers"}),e.jsx("div",{className:`testimonial-slider ${o?"animate":""}`,children:t.map((s,i)=>e.jsxs("div",{className:"testimonial-col",children:[e.jsx("img",{loading:"lazy",src:s.image,alt:"Techmiya review"}),e.jsxs("div",{children:[e.jsx("p",{children:s.review}),e.jsx("h3",{children:s.name}),e.jsx(x,{rating:s.rating})]})]},i))})]})})}const f=[{id:"1",videoId:"0Fe2Lpk91R0"},{id:"2",videoId:"UgF29StIDt4"},{id:"3",videoId:"0Fe2Lpk91R0"},{id:"4",videoId:"UgF29StIDt4"},{id:"5",videoId:"0Fe2Lpk91R0"},{id:"6",videoId:"UgF29StIDt4"}];function y(){const[t,o]=r.useState(f),[n,a]=r.useState(!1),[s,i]=r.useState(null),c=r.useRef(null);r.useEffect(()=>{},[void 0,"UC_x5XG1OV2P6uYZ5ujfWXBw"]);const g=[...t,...t];return r.useEffect(()=>{let l;const d=new IntersectionObserver(j=>{j.forEach(p=>{p.isIntersecting&&!n&&(l=setTimeout(()=>{a(!0)},800))})},{threshold:.1});return c.current&&d.observe(c.current),()=>{c.current&&d.unobserve(c.current),l&&clearTimeout(l)}},[n,t]),e.jsxs("section",{className:"shorts",ref:c,children:[e.jsxs("div",{className:"shorts-container",children:[e.jsx("h2",{children:"Our Projects"}),e.jsx("div",{className:`shorts-slider ${n&&!s?"animate":""}`,children:g.map((l,d)=>e.jsx("div",{className:"shorts-col",children:s===d?e.jsx("iframe",{width:"100%",height:"100%",src:`https://www.youtube.com/embed/${l.videoId}?autoplay=1&mute=0`,title:"YouTube Video",frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullScreen:!0}):e.jsxs("div",{className:"video-placeholder",onClick:()=>{i(d),a(!1)},children:[e.jsx("img",{src:`https://img.youtube.com/vi/${l.videoId}/hqdefault.jpg`,alt:"Video Thumbnail",loading:"lazy"}),e.jsx("div",{className:"play-overlay",children:e.jsx("i",{className:"fa fa-play-circle"})})]})},d))})]}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
            ...
            `}}),e.jsx(v,{}),e.jsx(y,{}),e.jsxs("section",{className:"faq",children:[e.jsx("h2",{children:"Frequently Asked Questions"}),e.jsxs("div",{children:[e.jsx("h3",{children:"Do you provide final year project guidance?"}),e.jsx("p",{children:"Yes, we provide full project development, documentation, and demo support."}),e.jsx("h3",{children:"Can students register online for projects?"}),e.jsx("p",{children:"Yes, students can register for project expo, games, and final year projects online."}),e.jsx("h3",{children:"Do you offer IEEE and real-world projects?"}),e.jsx("p",{children:"Yes, we provide IEEE + real-world industry projects for all branches."})]})]}),e.jsxs("section",{id:"feature",children:[e.jsxs("div",{className:"welcome",children:[e.jsx("p",{children:"WELCOME TO TECHMIYA"}),e.jsx("h2",{children:"Why Should You Join Us!!!"})]}),e.jsxs("div",{className:"service-box",children:[e.jsxs("div",{className:"single-service",children:[e.jsx("img",{loading:"lazy",src:"/images/cutt.png",alt:"Cutting Edge Technologies at Techmiya"}),e.jsx("div",{className:"overlay"}),e.jsxs("div",{className:"service-desc",children:[e.jsx("h3",{children:"Cutting Edge Technologies"}),e.jsx("hr",{})]})]}),e.jsxs("div",{className:"single-service",children:[e.jsx("img",{loading:"lazy",src:"/images/real.png",alt:"Real World Projects Experience"}),e.jsx("div",{className:"overlay"}),e.jsxs("div",{className:"service-desc",children:[e.jsx("h3",{children:"Real World Projects"}),e.jsx("hr",{})]})]}),e.jsxs("div",{className:"single-service",children:[e.jsx("img",{loading:"lazy",src:"/images/collab.png",alt:"Collaborative Learning Environment"}),e.jsx("div",{className:"overlay"}),e.jsxs("div",{className:"service-desc",children:[e.jsx("h3",{children:"Collaborative Learning"}),e.jsx("hr",{})]})]}),e.jsxs("div",{className:"single-service",children:[e.jsx("img",{loading:"lazy",src:"/images/mentor.png",alt:"Industrial Mentorship for Students"}),e.jsx("div",{className:"overlay"}),e.jsxs("div",{className:"service-desc",children:[e.jsx("h3",{children:"Industrial Mentorship"}),e.jsx("hr",{})]})]}),e.jsxs("div",{className:"single-service",children:[e.jsx("img",{loading:"lazy",src:"/images/creativity.png",alt:"Innovation and Creativity focus"}),e.jsx("div",{className:"overlay"}),e.jsxs("div",{className:"service-desc",children:[e.jsx("h3",{children:"Innovation and Creativity"}),e.jsx("hr",{})]})]}),e.jsxs("div",{className:"single-service",children:[e.jsx("img",{loading:"lazy",src:"/images/Certification.png",alt:"Project Certification and Recognition"}),e.jsx("div",{className:"overlay"}),e.jsxs("div",{className:"service-desc",children:[e.jsx("h3",{children:"Certification and Recognition"}),e.jsx("hr",{})]})]})]})]}),e.jsxs("div",{className:"internship-feedback",children:[e.jsx("h2",{children:"Project Feedback"}),e.jsx("p",{children:"Your feedback helps us improve our project program."}),e.jsx("img",{src:"/qr.png",alt:"Internship Feedback QR Code",className:"feedback-qr"}),e.jsx("a",{href:"https://forms.gle/miP4aAFBNfFcHdF18",target:"_blank",rel:"noopener noreferrer",className:"feedback-btn",children:"Click Here to Give Project Feedback"})]})]})}export{I as default};
